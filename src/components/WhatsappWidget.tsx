...
const whatsappNumber = "34605474930";
const whatsappMessage = "Hola, quiero informacion sobre sus servicios de mudanza.";
  ...
  return (
    ...
    >
      <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.3)] relative overflow-hidden">
        ...
        <svg viewBox="0 0 24 24" width="32" height="32" className="fill-white relative z-10">
